...
## but no adjusted close price (and values differ slightly) from when Alex got
## the data from Yahoo Finance on 2015-01-21 (=> we use the data as of 2015-01-21 here)
...
## SCI (Shanghai Composite Index; restricted to domestic investors)
SCI <- get_data("000001.SS", to=end)
save(SCI, file="SCI.rda", compress="xz")
